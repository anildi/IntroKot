...
fun someFunComp(prodName: String, niceness: Int = 0, price: Double, alias: String = ""): String {

    return prodName;
}

//TODO
fun task2Comp() : String {
...
fun listAdderComp(input: List<Int>) {
    val local = input
...
//TODO
fun initSkillComp(newSkill: String?) {
