...
/**
 * An Abstract class that deals with most of what it means to be a
...
open abstract class AbstractFileStudentDAO : BaseDAO<Student> {
    ...
    override fun update(id: Long, input: Student): Boolean {
        return state.students.computeIfPresent(id) { id, oldStudent -> input} != null
    }


    override fun delete(id: Long): Boolean {
        return state.students.remove(id) != null
    }
