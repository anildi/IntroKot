...
class CollectionOpChoices {
    ...
    fun testMapComputeIfAbsent() {
        ...
        //To specify result map type
        val map5: MutableMap<Int, MutableList<User>> = users.groupByTo(mutableMapOf()){ it.age }
        val map6: MutableMap<Int, MutableList<User>> = users.groupByTo(mutableMapOf(), User::age)
