...
class Parent(val id: Int, val name: String) {
...
//class Child(id: Int, name: String, val balance: Double = 0.0) : Parent(id, name) {
...
//}
//
//class ChildDefArgs(id: Int, name: String = "", val balance: Double = 0.0) : Parent(id, name) {
//
//    //'override' keyword *has* to be used to override a method
//    fun doStuff() {
//
