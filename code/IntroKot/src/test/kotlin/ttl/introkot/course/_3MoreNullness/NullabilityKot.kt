...
class NullabilityKot
{
     ...
     * e.g., Add a @Nullable annotation to getStuff to
     * get a compiler error here.
     */
    @Test
    fun testGetNullFromJava() {
    ...
    /**
     * This goes along with NullabilityJava.doStuff.
     * e.g. Add a NotNull annotation to the argument
     * to doStuff to get a compiler error here.
     */
    @Test
    fun testSetNullInJava() {
        val jc = NullabilityJava()
