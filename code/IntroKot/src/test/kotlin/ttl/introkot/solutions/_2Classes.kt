...
import ttl.introkot.student.tasks.ClassesTasks
...
/*****************************Start Tests******************************************/
class ThumbTackTestsSol {

    val classesTasks = ClassesTasksSol()
    ...
    @Test
    fun testTask5() {
        val result = ClassesTasksSol.greeting()
