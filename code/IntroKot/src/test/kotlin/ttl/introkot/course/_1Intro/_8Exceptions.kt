//To specify a class name for the generated class.
...
//Note - You can add an Exception Declaration
// if you like, but it makes
// no difference when you call from Kotlin.
// Java code will see it as a throws declaration.
// Also note that Exception Declarations are annotations in Kotlin.
