 ...
 * @author whynot
 *
 * Various type of returns. And inlining.
 *
 * For more info on inlining: https://kotlinlang.org/docs/inline-functions.html
 */
...
class ReturnsTest {
    ...
    fun extendedInlineExample() {
        ...
        val z = extendedInlineExample("hel") { str ->
            if (str.length < 5) {
                //A plain return would return from the enclosing function.
                //i.e. extendedInlineExample()
                //Since that is a Unit function, a return with a value is not allowed.
                //Only a plain return.
...
//        return lr                //This will return back to the caller of 'extendedInlineExample'
    ...
    //If this function is not inlined, the 'func' argument in the function
    // above will need a 'crossinline'
